 ...
 * </p>
 * <ul>
 *   <li>{@link de.luh.se.mbse.network.textualeditor.amf.impl.NetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.luh.se.mbse.network.textualeditor.amf.impl.NetworkImpl#getChannel <em>Channel</em>}</li>
 *   <li>{@link de.luh.se.mbse.network.textualeditor.amf.impl.NetworkImpl#getStatemachine <em>Statemachine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AmfPackage.NETWORK__NAME, oldName, name));
  }
