 ...
 */
package de.luh.se.mbse.statemachine.textualeditor.services;
...
public class AMFGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NetworkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.Network");
	...
	public class StatemachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.Statemachine");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.EString");
	...
	public class ChannelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.Channel");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TypeOfChannelElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.TypeOfChannel");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EventElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "de.luh.se.mbse.statemachine.textualeditor.AMF.Event");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.luh.se.mbse.statemachine.textualeditor.AMF".equals(grammar.getName())) {
				return grammar;
			}
